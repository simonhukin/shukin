class EnquiriesController < ApplicationController
  ...
  def create
    ...
    @enquiry.attributes = {'product_ids' => []}.merge(params[:enquiry] || {})

    #@quote.attributes = {'quantity' => []}.merge(params[:quantity] || {})
...
#    @enquiry.attributes = {'product_ids' => []}.merge(params[:enquiry] || {})
    ...
    @enquiry.products_pre_update(params)
    params[:enquiry].delete(:quotes_attributes)
    params[:enquiry].delete(:product_ids)
